...
namespace FastUnityCreationKit.UI.Context.Providers.Base
{
    ...
    {
        [SerializeField] [TitleGroup(PROVIDER_CONFIGURATION)] [Required] [CanBeNull]
        ...
        protected override void Setup()
        {
            ...
            if (providerReference) providerReference.OnContextChanged += OnContextChangedCallback;
        }
        ...
        /// </summary>
        public override TContextBase Provide()
        {
            return providerReference ? providerReference.Provide() : default;
        }
    }
}