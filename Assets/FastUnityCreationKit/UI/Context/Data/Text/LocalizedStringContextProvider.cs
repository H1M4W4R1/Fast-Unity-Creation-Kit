...
namespace FastUnityCreationKit.UI.Context.Data.Text
{
    ...
    {
        [Required] [SerializeField] [TitleGroup(PROVIDER_CONFIGURATION)] [CanBeNull]
        ...
        /// </summary>
        [CanBeNull] public LocalizedString LocalizedString => localizedString;
        ...
        protected override void Setup()
        {
            ...
            if (localizedString != null) localizedString.StringChanged += OnStringChanged;
        }
