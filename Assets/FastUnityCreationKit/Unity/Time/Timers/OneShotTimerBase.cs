...
namespace FastUnityCreationKit.Unity.Time.Timers
{
    ...
    public abstract class OneShotTimerBase : TimerBase
    {
        ...
        [UsedImplicitly] private new void Start(bool withEvents)
        {
            base.Start(withEvents);
        }

        [UsedImplicitly] private new void Reset(bool toFull, bool withEvents)
        {
            base.Reset(toFull, withEvents);
        }

        [UsedImplicitly] private new void Stop(bool withEvents)
        {
            base.Stop(withEvents);
        }
