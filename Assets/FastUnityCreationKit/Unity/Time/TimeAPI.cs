...
namespace FastUnityCreationKit.Unity.Time
{
    ...
    public static class TimeAPI
    {
        ...
        /// </summary>
        public static void ResumeTimeUsing(in PauseObject pauseObject) => PauseObjects.Remove(pauseObject);
        
        /// <summary>
        /// Forces time to be resumed (clears all objects from pause list).
        /// This should be used with EXTREME caution.
        /// </summary>
        public static void ForceResumeTime() => PauseObjects.Clear();
        
        /// <summary>
        /// Sets the time scale.
        /// </summary>
        /// <param name="timeScale">New time scale.</param>
        public static void SetTimeScale(float timeScale) => TimeMultiplier = timeScale;
        
        /// <summary>
        /// Check if specified time mode ignores time scale.
        /// </summary>
        public static bool IgnoresTimeScale(this UpdateTime updateMode) => updateMode != UpdateTime.DeltaTime;

        /// <summary>
        /// Check if specified time mode ignores pause.
        /// </summary>
        public static bool IgnoresPause(this UpdateTime updateMode) => updateMode != UpdateTime.DeltaTime;
    }
}