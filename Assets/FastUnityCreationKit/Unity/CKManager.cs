...
namespace FastUnityCreationKit.Unity
{
    ...
    public abstract class CKManager<TManagerType> : CKMonoBehaviour,
        IMonoBehaviourSingleton<TManagerType>
        where TManagerType : CKManager<TManagerType>, new()
    {
        /// <summary>
        ...
        protected override void Awake()
        {
            ...
            if (GetType() != typeof(TManagerType))
                Guard<ValidationLogConfig>.Fatal(
                    "Type mismatch. Type of the manager should be the same as the generic type.");
