...
namespace FastUnityCreationKit.Unity.Actions
{
    ...
    {
        private const string COOLDOWN_TO_STRING = "@" + nameof(CooldownTimer) + "." + nameof(ActionCooldown.ToString) + "()";
        ...
        /// </summary>
        [ShowInInspector] [TitleGroup("Cooldown")] [Unit(Units.Second)]
        ...
        [ShowInInspector] [ProgressBar(0, nameof(CooldownTime))]
