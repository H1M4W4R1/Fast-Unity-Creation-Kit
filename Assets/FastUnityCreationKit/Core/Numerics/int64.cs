...
namespace FastUnityCreationKit.Core.Numerics
{
    ...
    [BurstCompile]
    [Serializable]
    public struct int64 : ISignedNumber, INegateSupport<int64>, ISupportsFloatConversion<int64>,
        ...
        IDivideOperationSupport<float32, float32>, IDivideOperationSupport<float64, float64>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int64 FromFloat(float value) => _value = (long) value;
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int64 FromDouble(double value) => _value = (long) value;
        
#region OP_ADDITION

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int64 Add(in int8 rightHandSide) => _value + rightHandSide;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int64 Add(in int16 rightHandSide) => _value + rightHandSide;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int64 Add(in int32 rightHandSide) => _value + rightHandSide;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int64 Add(in int64 rightHandSide) => _value + rightHandSide;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int64 Add(in uint8 rightHandSide) => _value + rightHandSide;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int64 Add(in uint16 rightHandSide) => _value + rightHandSide;
...
#region OP_MULTIPLICATION
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int64 Multiply(in int8 rightHandSide) => _value * rightHandSide;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int64 Multiply(in int16 rightHandSide) => _value * rightHandSide;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int64 Multiply(in int32 rightHandSide) => _value * rightHandSide;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int64 Multiply(in int64 rightHandSide) => _value * rightHandSide;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int64 Multiply(in uint8 rightHandSide) => _value * rightHandSide;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int64 Multiply(in uint16 rightHandSide) => _value * rightHandSide;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int64 Multiply(in uint32 rightHandSide) => _value * rightHandSide;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float32 Multiply(in uint64 rightHandSide) => (float32) _value * rightHandSide;
...
#region OP_SUBTRACTION
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int64 Subtract(in int8 rightHandSide) => _value - rightHandSide;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int64 Subtract(in int16 rightHandSide) => _value - rightHandSide;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int64 Subtract(in int32 rightHandSide) => _value - rightHandSide;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int64 Subtract(in int64 rightHandSide) => _value - rightHandSide;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int64 Subtract(in uint8 rightHandSide) => _value - rightHandSide;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int64 Subtract(in uint16 rightHandSide) => _value - rightHandSide;
...
#region OP_DIVISION
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float32 Divide(in int8 rightHandSide) => (float) _value / rightHandSide;
