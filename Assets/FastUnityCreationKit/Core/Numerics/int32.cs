...
namespace FastUnityCreationKit.Core.Numerics
{
    ...
    [BurstCompile]
    [Serializable]
    public struct int32 : ISignedNumber, INegateSupport<int32>, ISupportsFloatConversion<int32>,
        ...
        IDivideOperationSupport<float32, float32>, IDivideOperationSupport<float64, float64>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int32 FromFloat(float value) => _value = (int) value;
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int32 FromDouble(double value) => _value = (int) value;
...
#region OP_ADDITION
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int32 Multiply(in int8 rightHandSide) => _value * rightHandSide;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int32 Subtract(in int8 rightHandSide) => _value - rightHandSide;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float32 Subtract(in uint64 rightHandSide) => (float32) _value - rightHandSide;
