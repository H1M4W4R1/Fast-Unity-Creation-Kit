...
namespace FastUnityCreationKit.Core.Logging
{
    ...
    {
        private static readonly LoggerWrapper<TLogType> _loggerReference;
    ...
    public static class Guard
    {
        ...
        {
            return config.MinimumLevel.SetMinimumLevel(level);
        }
        ...
        public static LoggerConfig SetMinimumLevel([NotNull] this LoggerMinimumLevelConfig config, LogLevel level)
        {
            switch (level)
            {
                case LogLevel.Verbose: return config.Verbose();
                case LogLevel.Debug: return config.Debug();
                case LogLevel.Info: return config.Info();
                case LogLevel.Warning: return config.Warning();
                case LogLevel.Error: return config.Error();
                case LogLevel.Fatal: return config.Fatal();
