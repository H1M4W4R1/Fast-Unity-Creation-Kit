...
namespace FastUnityCreationKit.Core.Extensions
{
    public static class ColorExtensions
    {
        ...
        [BurstCompile]
        public static void Gradient(in float4 fromColor, in float4 toColor, float t, out float4 result)
        {
        ...
        [BurstCompile]
        public static void GradientBidirectional(in float4 fromColor, in float4 positiveColor, in float4 negativeColor, float t, out float4 result)
        {
            ...
            {
                case >= 0f:
                    Gradient(fromColor, positiveColor, t, out result);
                    break;
                default:
                    Gradient(fromColor, negativeColor, -t, out result);
                    break;
            }
        }
        ...
        /// </summary>
        public static Color GradientBidirectional(this Color fromColor, Color positiveColor, Color negativeColor, float t)
            => t > 0 ? Gradient(fromColor, positiveColor, t) : Gradient(fromColor, negativeColor, -t);
    }
}