...
{
    [TestFixture]
    public sealed class PriorityTests : TestFixtureBase
    {
        [Test]
        ...
        [Test]
        public void
            PrioritizedList_SortsObjects_InCorrectOrder_WhenObject_IsInserted_WithMultipleObjects_WithEqualPriority()
        {
            // Arrange
            PrioritizedList<ObjectWithPriority> list = new PrioritizedList<ObjectWithPriority>();
            ObjectWithPriority firstObject = new ObjectWithPriority(1);
